...
<pre style="position: relative;"><strong>Input:</strong> nums = [8,6,1,5,3]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [5,4,8,7,10,2]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [6,5,4,3,4,5]
