...
<pre style="position: relative;"><strong>Input:</strong> nums = [4,3,2,4], x = 2
...
<pre style="position: relative;"><strong>Input:</strong> nums = [5,3,2,10,15], x = 1
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3,4], x = 3
